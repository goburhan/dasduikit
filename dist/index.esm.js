...
var getFontSize = function (_a) {
    ...
    return small ? "16px" : fontSize || "18px";
};
...
var Icon$v = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/cosmosium/9.png" })));
};
...
var SpinnerIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React.createElement("image", { width: "96", height: "96", href: "/images/spinner.svg" })));
};
...
var Icon$16 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("g", null,
            React.createElement("path", { d: "M11,16c0,2.8,2.2,5,5,5s5-2.2,5-5s-2.2-5-5-5S11,13.2,11,16z" }),
            React.createElement("path", { d: "M12.2,10.9c0.1,0,0.2,0,0.2,0c0.5,0,0.9-0.3,1-0.8c0.3-1.3,0.9-2.4,1.9-3.3C17.1,5,19.6,4.4,22.1,5\n\t\tc0.5,0.1,1.1-0.2,1.2-0.7c0.1-0.5-0.2-1.1-0.7-1.2c-3.1-0.8-6.4,0.1-8.7,2.3c-1.2,1.2-2,2.7-2.4,4.3C11.4,10.2,11.7,10.8,12.2,10.9\n\t\tz" }),
            React.createElement("path", { d: "M9.2,15.2c0.2,0,0.4,0,0.5-0.2c0.5-0.3,0.6-0.9,0.3-1.4c-0.7-1.1-1-2.4-1-3.7c0-2.5,1.3-4.8,3.5-6.1\n\t\tC13,3.7,13.1,3,12.9,2.6c-0.3-0.5-0.9-0.6-1.4-0.4C8.7,3.8,7,6.8,7,10c0,1.7,0.5,3.3,1.3,4.7C8.5,15,8.9,15.2,9.2,15.2z" }),
            React.createElement("path", { d: "M9.7,20.5c0.1,0,0.2,0,0.2,0c0.5,0,0.9-0.3,1-0.8c0.1-0.5-0.2-1.1-0.7-1.2c-1.3-0.3-2.4-0.9-3.3-1.9C5,14.9,4.4,12.4,5,9.9\n\t\tc0.1-0.5-0.2-1.1-0.7-1.2C3.7,8.6,3.2,8.9,3.1,9.4c-0.8,3.1,0.1,6.4,2.3,8.7C6.6,19.3,8.1,20.1,9.7,20.5z" }),
            React.createElement("path", { d: "M14.7,23.7c0.5-0.3,0.6-0.9,0.3-1.4c-0.3-0.5-0.9-0.6-1.4-0.3c-1.1,0.7-2.4,1-3.7,1c-2.5,0-4.8-1.3-6.1-3.5\n\t\tC3.7,19,3,18.9,2.6,19.1c-0.5,0.3-0.6,0.9-0.4,1.4C3.8,23.3,6.8,25,10,25C11.7,25,13.3,24.5,14.7,23.7z" }),
            React.createElement("path", { d: "M19.8,21.1c-0.5-0.1-1.1,0.2-1.2,0.7c-0.3,1.3-0.9,2.4-1.9,3.3c-1.8,1.8-4.4,2.5-6.8,1.8c-0.5-0.1-1.1,0.2-1.2,0.7\n\t\ts0.2,1.1,0.7,1.2c0.8,0.2,1.5,0.3,2.3,0.3c2.4,0,4.7-0.9,6.4-2.6c1.2-1.2,2-2.7,2.4-4.3C20.6,21.8,20.3,21.2,19.8,21.1z" }),
            React.createElement("path", { d: "M22.3,16.9c-0.5,0.3-0.6,0.9-0.3,1.4c0.7,1.1,1,2.4,1,3.7c0,2.5-1.3,4.8-3.5,6.1c-0.5,0.3-0.6,0.9-0.4,1.4\n\t\tc0.2,0.3,0.5,0.5,0.9,0.5c0.2,0,0.3,0,0.5-0.1c2.8-1.6,4.5-4.6,4.5-7.8c0-1.7-0.5-3.3-1.3-4.7C23.4,16.8,22.7,16.6,22.3,16.9z" }),
            React.createElement("path", { d: "M22.3,11.5c-0.5-0.1-1.1,0.2-1.2,0.7c-0.1,0.5,0.2,1.1,0.7,1.2c1.3,0.3,2.4,0.9,3.3,1.9c1.8,1.8,2.5,4.4,1.8,6.8\n\t\tc-0.1,0.5,0.2,1.1,0.7,1.2c0.1,0,0.2,0,0.3,0c0.4,0,0.8-0.3,1-0.7c0.8-3.1-0.1-6.4-2.3-8.7C25.4,12.7,23.9,11.9,22.3,11.5z" }),
            React.createElement("path", { d: "M29.8,11.5C28.2,8.7,25.2,7,22,7c-1.7,0-3.3,0.5-4.7,1.3c-0.5,0.3-0.6,0.9-0.3,1.4c0.3,0.5,0.9,0.6,1.4,0.3\n\t\tc1.1-0.7,2.4-1,3.7-1c2.5,0,4.8,1.3,6.1,3.5c0.2,0.3,0.5,0.5,0.9,0.5c0.2,0,0.3,0,0.5-0.1C29.9,12.6,30.1,12,29.8,11.5z" }))));
};

var Icon$17 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 465.61 465.61" }, props),
        React.createElement("g", null,
            React.createElement("polygon", { points: "51.559,308.815 156.795,414.051 201.013,385.202 80.407,264.596 \t" }),
            React.createElement("polygon", { points: "198.667,87.057 113.175,91.204 22.961,181.418 84.654,201.069 \t" }),
            React.createElement("polygon", { points: "284.192,442.648 374.406,352.434 378.553,266.942 264.541,380.955 \t" }),
            React.createElement("path", { d: "M0.001,360.612L34,326.612l21.213,21.213l-33.999,33.999L0.001,360.612z" }),
            React.createElement("path", { d: "M104.992,465.61l-21.213-21.213l33.999-34l21.213,21.213L104.992,465.61z" }),
            React.createElement("path", { d: "M25.021,417.876l50.122-50.122l21.213,21.213l-50.122,50.122L25.021,417.876z" }),
            React.createElement("circle", { cx: "364.939", cy: "100.67", r: "15" }),
            React.createElement("path", { d: "M454.967,10.643c-58.835-22.219-127.811-9.648-175.172,37.712L93.194,234.956l137.46,137.459l186.601-186.601\n\t\tC464.615,138.454,477.185,69.478,454.967,10.643z M396.759,132.49c-17.574,17.573-46.066,17.573-63.64,0\n\t\tc-17.574-17.574-17.574-46.066,0-63.64s46.066-17.574,63.64,0C414.332,86.424,414.332,114.917,396.759,132.49z" }))));
};
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        isMobile ? (React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "12px" }, isPushed ? (React.createElement(Icon$L, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$K, { width: "24px", color: "textSubtle" })))) : (React.createElement(React.Fragment, null)),
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav; _a.toggleTheme; _a.isDark; var cakePriceUsd = _a.cakePriceUsd; _a.currentLang; _a.langs; _a.setLang; var priceLink = _a.priceLink, socials = _a.socials;
    if (!isPushed) {
    ...
    return (React.createElement(Container$4, null,
        ...
        //     //     var mr = socials && index < socials.length - 1 ? "8px" : 0;
        //     //     if (social.items) {
...
var Panel = function (props) {
    ...
    return (React.createElement(StyledPanel, { style: isMobile ? { display: 'flex' } : { display: 'none' }, isPushed: isPushed, showMenu: showMenu },
        React.createElement(PanelBody, __assign({}, props)),
        React.createElement(PanelFooter, __assign({}, props))));
};
var templateObject_1$D;

var rainbowAnimation$1 = keyframes(templateObject_1$E || (templateObject_1$E = __makeTemplateObject(["\n  0%,\n  100% {\n    background-position: 0 0;\n  }\n  50% {\n    background-position: 100% 0;\n  }\n"], ["\n  0%,\n  100% {\n    background-position: 0 0;\n  }\n  50% {\n    background-position: 100% 0;\n  }\n"])));
var LinkLabel$1 = styled.div(templateObject_2$d || (templateObject_2$d = __makeTemplateObject(["\n  color: ", ";\n  transition: color 0.4s;\n"], ["\n  color: ", ";\n  transition: color 0.4s;\n"])), function (_a) {
    var isPushed = _a.isPushed, theme = _a.theme;
    return (isPushed ? theme.colors.textSubtle : theme.colors.textSubtle);
});
var TopMenuEntry = styled.div(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  justify-content : center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background : ", ";\n  \n  color: ", ";\n  box-shadow: ", ";\n  width: 120px;\n  a {\n    display: flex;\n    align-items: center;\n    justify-content : center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  justify-content : center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background : ", ";\n  \n  color: ", ";\n  box-shadow: ", ";\n  width: 120px;\n  a {\n    display: flex;\n    align-items: center;\n    justify-content : center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"])), MENU_ENTRY_HEIGHT, function (_a) {
    var secondary = _a.secondary;
    return (secondary ? "0 32px" : "0 16px");
}, function (_a) {
    var secondary = _a.secondary;
...
var AccordionContent$1 = styled.div(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  max-height: ", ";\n  &:hover {\n    ", ";\n  }\n  position:absolute;\n  top:100;\n  transition: max-height 0.3s ease-out;\n  overflow: hidden;\n  border-color: ", ";\n  border-style: solid;\n  border-bottom-radius : 6px;\n  width : 120px;\n"], ["\n  max-height: ", ";\n  &:hover {\n    ", ";\n  }\n  position:absolute;\n  top:100;\n  transition: max-height 0.3s ease-out;\n  overflow: hidden;\n  border-color: ", ";\n  border-style: solid;\n  border-bottom-radius : 6px;\n  width : 120px;\n"])), function (_a) {
    var isOpen = _a.isOpen, maxHeight = _a.maxHeight;
    return (isOpen ? maxHeight + "px" : 0);
}, function (_a) {
...
var Accordion$1 = function (_a) {
    var label = _a.label, icon = _a.icon, isPushed = _a.isPushed; _a.pushNav; var _b = _a.initialOpenState, initialOpenState = _b === void 0 ? false : _b, children = _a.children, className = _a.className, activeAccordion = _a.activeAccordion, setActiveAccordion = _a.setActiveAccordion;
    var _c = useState(initialOpenState), isOpen = _c[0], setIsOpen = _c[1];
    var handleClick = function () {
    ...
    return (React.createElement(Container$5, null,
        React.createElement(TopMenuEntry, { onClick: handleClick, className: className, onMouseOver: function () { return setActiveAccordion(label); }, onMouseLeave: function () { return setActiveAccordion(''); } },
            icon,
            React.createElement(LinkLabel$1, { isPushed: isPushed }, label),
            isOpen ? React.createElement(Icon$8, null) : React.createElement(Icon$7, null)),
        React.createElement(AccordionContent$1, { onMouseOver: function () { return setActiveAccordion(label); }, onMouseLeave: function () { return setActiveAccordion(''); }, isOpen: activeAccordion === label, isPushed: isPushed, maxHeight: React.Children.count(children) * MENU_ENTRY_HEIGHT }, children)));
};
...
var TopMenu = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, isMobile = _a.isMobile, links = _a.links;
    var location = useLocation();
    var _b = useState(), showAccordion = _b[0], setShowAccordion = _b[1];
    // Close the menu when a user clicks a link on mobile
    var handleClick = isMobile ? function () { return pushNav(false); } : undefined;
    return (React.createElement(Container$6, { style: isMobile ? { display: 'none' } : { display: 'flex' } }, links.map(function (entry) {
        //var Icon = Icons$2[entry.icon];
        var iconElement = React.createElement(Icon, { width: "24px", mr: "8px" });
        var calloutClass = entry.calloutClass ? entry.calloutClass : undefined;
        if (entry.items) {
            return (React.createElement(Accordion$1, { key: entry.label, isPushed: isPushed, pushNav: pushNav, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass, activeAccordion: showAccordion, setActiveAccordion: setShowAccordion }, isPushed &&
                entry.items.map(function (item) { return (React.createElement(TopMenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                    React.createElement(MenuLink, { href: item.href }, item.label))); })));
        }
        return (React.createElement(TopMenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
            React.createElement(MenuLink, { href: entry.href, onClick: handleClick },
                //iconElement,
                React.createElement(LinkLabel$1, { isPushed: isPushed }, entry.label))));
    })));
};
var templateObject_1$G;
...
var WalletCard = function (_a) {
    ...
    return (React.createElement(Button, { fullWidth: true, variant: "primary", onClick: function () {
            login(walletConfig.connectorId);
            window.localStorage.setItem(localStorageKey, "1");
            onDismiss();
        }, style: { justifyContent: "space-between" }, mb: mb, id: "wallet-connect-" + title.toLocaleLowerCase() },
        React.createElement(Text, { bold: true, color: "contrast", mr: "16px" }, title),
        React.createElement(Icon, { width: "32px" })));
};

styled(Link)(templateObject_1$H || (templateObject_1$H = __makeTemplateObject(["\n  display: flex;\n  align-self: center;\n  align-items: center;\n  margin-top: 24px;\n"], ["\n  display: flex;\n  align-self: center;\n  align-items: center;\n  margin-top: 24px;\n"])));
...
var templateObject_1$K, templateObject_2$h, templateObject_3$9, templateObject_4$3, templateObject_5$1;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#b2caff", background: "#1E2225", backgroundDisabled: "#3c3742", contrast: "#E6F8F1", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "rgba(255,255,255,0.15)", text: "#E6F8F1", textDisabled: "#666171", textSubtle: "#ffffff", borderColor: "#524B63", card: "#0B1018", white: '#FFFFFF', gradients: {
        bubblegum: "linear-gradient(139.73deg, #313D5C 0%, #3D2A54 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#1E2225", backgroundDisabled: "#3c3742", contrast: "#E6F8F1", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#FEECE9", text: "#E6F8F1", textDisabled: "#666171", textSubtle: "#2EB086", borderColor: "#524B63", card: "#0B1018", white: '#FFFFFF', gradients: {
        bubblegum: "linear-gradient(139.73deg, #313D5C 0%, #3D2A54 100%)",
    } });
...
var _a$2, _b;
var PRIMARY = variants.PRIMARY, SECONDARY = variants.SECONDARY, TERTIARY = variants.TERTIARY, TEXT = variants.TEXT, DANGER = variants.DANGER, SUBTLE = variants.SUBTLE, SUCCESS = variants.SUCCESS, BGCARD = variants.BGCARD;
var light$1 = (_a$2 = {},
    _a$2[PRIMARY] = {
...
var dark$1 = (_b = {},
    ...
    _b[BGCARD] = __assign(__assign({}, light$1.tertiary), { background: darkColors.card, backgroundActive: darkColors.card, backgroundHover: darkColors.card }),
    _b);
